...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadStr:"<i uk-icon icon='cloud-upload'></i> &nbsp; Cargar archivo",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "Borrar",
            doneStr: "Listo",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "No esta permitido. Extensiones permitidas: ",
            duplicateErrorStr: "No esta permitido. El archivo ya existe.",
            sizeErrorStr: "No esta permitido. Tamaño maximo permitido: ",
            uploadErrorStr: "Subida no permitida.",
            maxFileCountErrorStr: " no esta permitido. Maximo de archivos subidos:",
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.statusbar = $("<div class='ajax-file-upload-statusbar'></div>").css('float','left');
            ...
            this.abort.addClass("uk-hidden");
            this.done.addClass("ajax-file-upload-green");
			this.download.addClass("ajax-file-upload-green");            
            this.cancel.addClass("uk-hidden");
            this.del.addClass("uk-hidden");
