...
/* NOTA: además de agregar el material, noté que algunos usuarios llenan los campos con ",", haciendo que se creen columnas demás, esto se soluciona con str_replace(",",";",$campo). */
	}
}
